...
import { User, LogOut, ChevronRight, Phone, Mail, ClipboardList, HelpCircle, Leaf, Bell, Pencil, MessageCircle } from 'lucide-react';
  ...
  if (!user) return (
    <div className="pb-4 max-w-2xl mx-auto lg:px-6">
      ...
      <div className="px-6 py-16 text-center">
        ...
        <Link to="/login" className="inline-flex mt-5 items-center gap-2 bg-emerald-700 text-white px-5 h-11 rounded-full text-sm font-semibold">Sign in</Link>
        <Link to="/signup" className="inline-flex mt-2 items-center gap-2 bg-white border border-emerald-700 text-emerald-700 px-5 h-11 rounded-full text-sm font-semibold">Create an account</Link>
      </div>
    </div>
  );
    ...
    <div className="pb-4 max-w-2xl mx-auto lg:px-6">
      ...
      <div className="px-4 mt-3">
        <div className="rounded-2xl bg-gradient-to-br from-emerald-700 to-emerald-500 text-white p-4 flex items-center gap-3 relative overflow-hidden">
          ...
          <Link to="/profile/edit" className="shrink-0 inline-flex items-center gap-1 bg-white/20 hover:bg-white/30 text-white text-xs font-semibold px-3 h-8 rounded-full">
        ...
        <div className="mt-4 space-y-2">
          ...
          <Row icon={MessageCircle} label="Messages" to="/messages" />
